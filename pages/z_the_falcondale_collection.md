...
### In terms of variety, $$E \supset S1 \supset MS$$ so what stafford draws a bunch of attenuator arrows [attenuator symbol](http://www.electronicshub.org/wp-content/uploads/2015/05/attenuator.jpg) from E to S1 & S1 to MS; thence, amplifier arrows [amplifier symbol](https://upload.wikimedia.org/wikipedia/commons/thumb/d/dd/Amplifier_symbol.svg/1024px-Amplifier_symbol.svg.png){:height 90, :width 93} from MS to S1 to E.
### if something is in homeostasis, there's no issue. you're a nice black box
